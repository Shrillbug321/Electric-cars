...
import { TextField, Box, FormControl,OutlinedInput,InputLabel, DialogTitle, DialogContent, DialogActions, Button, Container, Stack, Select, MenuItem, Dialog } from '@mui/material';
...
const RegisterForm = () => {
    ...
    const check = () => {
        console.log('Left city: '+leftCity+'\n')
        console.log('LD: '+leftDistance+'\n')
        console.log('Right city: '+rightCity+'\n')
        console.log('RD: '+rightDistance+'\n')
        // event.preventDefault()
        // addCharger().then()
		// addLeftConnection().then()
		// addRightConnection().then(r => alert('Dodano ładowarkę'))
  ...
  if (loading) return (<div>Loading...</div>)
    ...
    function cityOptions() {
        ...
        for (let city of cities) {
            options.push(<MenuItem value={city.props.children.props.children}>{city.props.children.props.children}</MenuItem >)
        }
        return options;
    }
            ...
            <form onSubmit={handleSubmit} action={<Link to="/login" />}>
                ...
                <Dialog disableEscapeKeyDown open={open} onClose={handleClose}>
                    ...
                    <FormControl sx={{ m: 1, minWidth: 200, padding: '10px' }}>
                        <InputLabel id="demo-dialog-select-label">Left City</InputLabel>
                        <Select
                ...
                <Dialog disableEscapeKeyDown open={open2} onClose={handleClose2}>
                    ...
                    <DialogContent>
                    <FormControl sx={{ m: 1, minWidth: 200, padding: '10px' }}>
                        <InputLabel id="demo-dialog-select-label">Right City</InputLabel>
                        <Select
                        labelId="demo-dialog-select-label"
                        id="rightCity"
                        name="rightCity"
                ...
                <Box textAlign="center"> {/* Dodaj styl wyśrodkowujący zawartość */}
